...
internal OSXApplicationCode
osx_load_application_code(char *application_dll_path, Print *print)
{
	OSXApplicationCode result;
...
main(int num_args, char** args)
{
	...
	osx_init_platform(&app_state.platform);
